    ...
    <div class="card-body px-0 py-3">
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-xl-6">
                <div class="card h-100 border-0 shadow-sm">
                    <div class="card-body">
                        <h5 class="card-title mb-3"><i class="fa-solid fa-mountain-sun me-2"></i>Total cumulativ</h5>
                        <div class="position-relative">
                            <canvas id="cumulativeHoursChart" height="220" class="w-100"></canvas>
                            <p class="text-muted text-center mb-0 small" id="cumulativeHoursChartFallback" style="display: none;">
                                Nu există ore înregistrate pentru intervalul selectat.
                            </p>
                        </div>
                    </div>
