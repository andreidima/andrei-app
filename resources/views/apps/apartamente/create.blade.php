            ...
            <div class="shadow-lg" style="border-radius: 40px;">
                <div class="border border-secondary p-2 culoare2" style="border-radius: 40px 40px 0 0;">
                    <span class="badge text-light fs-5">
                        <i class="fa-solid fa-building me-1"></i>Adaugare apartament
                    </span>
                </div>
                ...
                <div class="card-body py-2 border border-secondary" style="border-radius: 0 0 40px 40px;">
                    <form class="needs-validation" novalidate method="POST" action="/apps/apartamente">
                        @include ('apps.apartamente.form', [
                            'apartament' => new App\Models\Apps\Apartament,
                            'buttonText' => 'Adauga apartament'
                        ])
                    </form>
                </div>
            </div>
